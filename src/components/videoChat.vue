<template>
    <div class="video-chat-wrap">
        ...
        <div v-else>
			...
			<el-button type="primary" @click="acceptVideoChat">接受</el-button>
			<el-row>
				<el-col
					:span="24"
					class="message-wrap"
    ...
    export default {
        data() {
            return {
				...
				messageBody: '',
				currentLoginUser: '',
				isVideoChating: false, // 是否正在进行视频通话
                chatToolList: [
                    {
						text: '表情',
						type: 'emoji',
